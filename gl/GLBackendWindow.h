 ...
 * @brief Declaration of the GLBackendWindow class for managing window properties in the 3D modeler application.
 */
...
namespace _3dmodeler
{
     ...
     */
    class _3DMODELER_DLL_EXPORT GLBackendWindow : public entity::Entity
    {
    public:
        /**
