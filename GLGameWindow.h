/**
 * @file GLGameWindow.h
 * @brief Declaration of the GLGameWindow class for managing window properties in the 3D modeler application.
 */
...
public:
    /**
     * @brief Default constructor for GLGameWindow.
     */
    GLGameWindow();

    /**
     * @brief Destructor for GLGameWindow.
     */
