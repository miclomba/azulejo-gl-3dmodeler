/**
 * @file GLGameEmitters.h
 * @brief Declaration of the GLGameEmitters class which manages input event emitters for a 3D modeling application.
 */
...
public:
    ...
    std::shared_ptr<events::EventEmitter<
        void(GLint w_, GLint h_, const std::array<GLfloat, 16>& projOrtho_, const std::array<GLfloat, 16>& projPerspective_)>> GetDrawEmitter();
    
    /**
     * @brief Getter for the Pick event emitters.
     */
    std::shared_ptr<events::EventEmitter<
        void(const int _x, const int _y, const int _h, const std::string& _viewport)>> GetPickEmitter();
    
    /**
     * @brief Getter for the Mouse event emitters.
     */
    std::shared_ptr<events::EventEmitter<
        void(const int _button, const int _state, const int _x, const int _y, const int _w, const int _h)>> GetMouseEmitter();
    
    /**
     * @brief Getter for the Mouse Motion event emitters.
     */
    std::shared_ptr<events::EventEmitter<
        void(const int _x, const int _y, const int _w, const int _h, const std::array<GLfloat, 16>& _projOrtho)>> GetMouseMotionEmitter();
    
    /**
     * @brief Getter for the Action Menu event emitters.
     */
    std::shared_ptr<events::EventEmitter<
        void(const int _index)>> GetActionMenuEmitter();
...
private:
    ...
    // Other emitters
    std::shared_ptr<events::EventEmitter<
        void(GLint w_, GLint h_, const std::array<GLfloat, 16>& projOrtho_, const std::array<GLfloat, 16>& projPerspective_)>> drawEmitter_;
    std::shared_ptr<events::EventEmitter<
        void(const int _x, const int _y, const int _h, const std::string& _viewport)>> pickEmitter_;
    std::shared_ptr<events::EventEmitter<
        void(const int _button, const int _state, const int _x, const int _y, const int _w, const int _h)>> mouseEmitter_;
    std::shared_ptr<events::EventEmitter<
        void(const int _x, const int _y, const int _w, const int _h, const std::array<GLfloat, 16>& _projOrtho)>> mouseMotionEmitter_;
    std::shared_ptr<events::EventEmitter<
        void(const int _index)>> actionMenuEmitter_;
